...
function themNhanVien() {
    ...
    isValid = validation.kiemTraDungKyTu("name", "tbTen", "(*) vui long kiem tra dung ky tu");
    isValid = validation.kiemTraEmail("email", "tbEmail", "(*) vui long kiem tra email hop le ");
    //them vao mang
    if (isValid) {
...
function TimNhanVien() {
    ...
    //  }
    // JS es6
    mangNhanVienTimKiem = mangNhanVien.filter(function(nhanVien) { // dợi sẽ xảy ra rồi gọi hàm đó 
